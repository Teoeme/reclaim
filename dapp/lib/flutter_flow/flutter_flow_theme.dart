...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2C4A4F);
  late Color secondary = const Color(0xFF4D7C84);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFFA7DBF4);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xD1FDF4E8);
  late Color accent2 = const Color(0x4EFE8047);
  late Color accent3 = const Color(0x3C000000);
  late Color accent4 = const Color(0x4FA7DBF4);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFDF4E8);
  late Color secondary = const Color(0xFFFE8047);
  late Color tertiary = const Color(0xFFA7DBF4);
  ...
  late Color accent1 = const Color(0xD1FDF4E8);
  late Color accent2 = const Color(0x4EFE8047);
  late Color accent3 = const Color(0x4FA7DBF4);
