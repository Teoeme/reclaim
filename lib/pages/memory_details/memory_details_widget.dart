...
import 'memory_details_model.dart';
export 'memory_details_model.dart';

class MemoryDetailsWidget extends StatefulWidget {
  const MemoryDetailsWidget({super.key});

  static String routeName = 'MemoryDetails';
  static String routePath = '/memoryDetails';

  @override
  State<MemoryDetailsWidget> createState() => _MemoryDetailsWidgetState();
}

class _MemoryDetailsWidgetState extends State<MemoryDetailsWidget>
    with TickerProviderStateMixin {
  late MemoryDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MemoryDetailsModel());
                            ...
                            PageView(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    'https://images.unsplash.com/photo-1531273776218-7d1bd4db5447?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyMHx8Qmx1cnxlbnwwfHx8fDE3NDc3NzY2NDN8MA&ixlib=rb-4.1.0&q=80&w=1080',
                                    width: 300.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
